...
func harryPotter(character: String) {
...
let fav = "Hermione Granger"

harryPotter(fav)

//following the directions, but this isn't going to work because the variable is a constant 
...
func jayz(numberOfProblems:Int)  {
...
func bandRanking(number:Int, band:String) {
    print("My \(number) favorite band is \(band)")
    
}

bandRanking(3, band: "TV on the Radio")
/*: question7
...
madLib("Arya", noun: "ball", preposition: "beyond")
/*: question10
